      		...
      		<div class="row">
    	  		<div class="col-md-6 col-sm-6 col-xs-12">
    				...
    				<div class="form-group">
                        ...
                        -->
    					<input type="text" class="form-control" name="mov_title" value="<?= $filmInfosOmdb['Title']?>" placeholder="movie title" />
    				</div>

    				<div class="form-group">
    					<label>actors</label>
    					<input type="text" class="form-control" name="mov_actors" value="<?= $filmInfosOmdb['Actors']?>" placeholder="actors" />
    				</div>
    				...
    				<div class="form-group">
    					<label>release date</label>
      					<input type="text" class="form-control" name="mov_rel" value="<?=$filmInfosOmdb['Released'] ?>" placeholder="release date" />
      					<small class="form-text text-muted">format in YYYY-MM-DD (<?= date('Y-m-d') ?>)</small>
      				</div>
                    <div class="form-group">
                        <label>genre</label>
                        <p><?= $filmInfosOmdb['Genre']?></p>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
    				<div class="form-group">
    					...
    					<textarea rows="4" cols="50"  class="form-control" name="mov_plot"  placeholder="film plot" > <?=$filmInfosOmdb['Plot'] ?>      </textarea>
    				</div>
    				...
    				<div class="form-group">
                        ...
                        <img src="<?=$filmInfosOmdb['Poster'] ?>" alt="movie poster" height="150">
                        <input type="text" class="form-control" name="mov_post" value="<?=$filmInfosOmdb['Poster'] ?>" placeholder="release date" style="display:hidden"/>
